...
def _region_dialing_from_matches_number(
    numobj: PhoneNumber, region_dialing_from: str
) -> bool: ...
def is_possible_short_number_for_region(
    short_numobj: PhoneNumber, region_dialing_from: str
) -> bool: ...
def is_possible_short_number(numobj: PhoneNumber) -> bool: ...
def is_valid_short_number_for_region(
    short_numobj: PhoneNumber, region_dialing_from: str
) -> bool: ...
...
def _region_code_for_short_number_from_region_list(
    numobj: PhoneNumber, region_codes: tuple[str, ...]
) -> str | None: ...
...
def _matches_emergency_number_helper(
    number: str, region_code: str, allow_prefix_match: bool
) -> bool: ...
def is_carrier_specific(numobj: PhoneNumber) -> bool: ...
def is_carrier_specific_for_region(
    numobj: PhoneNumber, region_dialing_from: str
) -> bool: ...
def is_sms_service_for_region(
    numobj: PhoneNumber, region_dialing_from: str
) -> bool: ...
def _matches_possible_number_and_national_number(
    number: str, number_desc: PhoneNumberDesc | None
) -> bool: ...
