...
PHONE_METADATA_NZ = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="[1289]\\d{9}|50\\d{5}(?:\\d{2,3})?|[27-9]\\d{7,8}|(?:[34]\\d|6[0-35-9])\\d{6}|8\\d{4,6}",
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="2(?:[0-27-9]\\d|6)\\d{6,7}|2(?:1\\d|75)\\d{5}",
    ...
    premium_rate=PhoneNumberDesc(
        national_number_pattern="(?:1[13-57-9]\\d{5}|50(?:0[08]|30|66|77|88))\\d{3}|90\\d{6,8}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="8(?:1[16-9]|22|3\\d|4[045]|5[459]|6[235-9]|7[0-3579]|90)\\d{2,7}",
    ...
    number_format=[
        ...
        NumberFormat(
            ...
            format="\\1 \\2 \\3",
            leading_digits_pattern=["50[036-8]|8|90", "50(?:[0367]|88)|8|90"],
            national_prefix_formatting_rule="0\\1",
        ),
        NumberFormat(
            pattern="(\\d)(\\d{3})(\\d{4})",
