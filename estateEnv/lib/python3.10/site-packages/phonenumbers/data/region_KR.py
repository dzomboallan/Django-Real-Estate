...
PHONE_METADATA_KR = PhoneMetadata(
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="1(?:05(?:[0-8]\\d|9[0-6])|22[13]\\d)\\d{4,5}|1(?:0[0-46-9]|[16-9]\\d|2[013-9])\\d{6,7}",
    ...
    uan=PhoneNumberDesc(
        national_number_pattern="1(?:5(?:22|33|44|66|77|88|99)|6(?:[07]0|44|6[0168]|88)|8(?:00|33|55|77|99))\\d{4}",
