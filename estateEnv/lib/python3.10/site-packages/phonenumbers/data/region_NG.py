...
PHONE_METADATA_NG = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="2[0-24-9]\\d{8}|[78]\\d{10,13}|[7-9]\\d{9}|[1-9]\\d{7}|[124-7]\\d{6}",
        possible_length=(7, 8, 10, 11, 12, 13, 14),
        possible_length_local_only=(5, 6),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="20(?:[1259]\\d|3[013-9]|4[1-8]|6[024-689]|7[1-79]|8[2-9])\\d{6}|(?:(?:[1-356]\\d|4[02-8]|8[2-9])\\d|9(?:0[3-9]|[1-9]\\d))\\d{5}|7(?:0(?:[013-689]\\d|2[0-24-9])\\d{3,4}|[1-79]\\d{6})|(?:[12]\\d|4[147]|5[14579]|6[1578]|7[1-3578])\\d{5}",
        example_number="18040123",
        possible_length=(7, 8, 10),
        possible_length_local_only=(5, 6),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:702[0-24-9]|819[01])\\d{6}|(?:7(?:0[13-9]|[12]\\d)|8(?:0[1-9]|1[0-8])|9(?:0[1-9]|1[1-6]))\\d{7}",
