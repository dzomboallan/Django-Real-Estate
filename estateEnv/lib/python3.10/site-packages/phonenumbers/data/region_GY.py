...
PHONE_METADATA_GY = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[2-8]\\d{3}|9008)\\d{3}", possible_length=(7,)
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:2(?:1[6-9]|2[0-35-9]|3[1-4]|5[3-9]|6\\d|7[0-79])|3(?:2[25-9]|3\\d)|4(?:4[0-24]|5[56])|50[0-6]|77[1-57])\\d{4}",
        example_number="2201234",
        possible_length=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:510|6\\d\\d|7(?:[01]\\d|2[156]|31|49))\\d{4}",
