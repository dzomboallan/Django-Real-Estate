...
PHONE_METADATA_UY = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="0004\\d{2,9}|[1249]\\d{7}|(?:[49]\\d|80)\\d{5}",
        possible_length=(6, 7, 8, 9, 10, 11, 12, 13),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:1(?:770|9(?:20|87))|(?:2\\d|4[2-7])\\d\\d)\\d{4}",
    ...
    number_format=[
        NumberFormat(
            pattern="(\\d{3})(\\d{3,4})", format="\\1 \\2", leading_digits_pattern=["0"]
        ),
        NumberFormat(
            pattern="(\\d{3})(\\d{4})",
            format="\\1 \\2",
