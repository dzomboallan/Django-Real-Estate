...
PHONE_METADATA_RE = PhoneMetadata(
    ...
    mobile=PhoneNumberDesc(
        national_number_pattern="69(?:2\\d\\d|3(?:[06][0-6]|1[013]|2[0-2]|3[0-39]|4\\d|5[0-5]|7[0-37]|8[0-8]|9[0-479]))\\d{4}",
    ...
    voip=PhoneNumberDesc(
        national_number_pattern="9(?:399[0-3]|479[0-5]|76(?:2[27]|3[0-37]))\\d{4}",
