...
def _same_pattern(
    left: PhoneNumberDesc | None, right: PhoneNumberDesc | None
) -> bool: ...
...
class PhoneMetadata(UnicodeMixin, ImmutableMixin):
    ...
    short_data: bool
    @classmethod
    def metadata_for_region(
        cls, region_code: str, default: PhoneMetadata | None = ...
    ) -> PhoneMetadata | None: ...
    @classmethod
    def short_metadata_for_region(
        cls, region_code: str, default: PhoneMetadata | None = ...
    ) -> PhoneMetadata | None: ...
    @classmethod
    def metadata_for_nongeo_region(
        cls, country_code: int, default: PhoneMetadata | None = ...
    ) -> PhoneMetadata | None: ...
    @classmethod
    def metadata_for_region_or_calling_code(
        cls, country_calling_code: int, region_code: str
    ) -> PhoneMetadata | None: ...
    @classmethod
    def register_region_loader(
        cls, region_code: str, loader: Callable[[str], None]
    ) -> None: ...
    @classmethod
    def register_short_region_loader(
        cls, region_code: str, loader: Callable[[str], None]
    ) -> None: ...
    @classmethod
    def register_nongeo_region_loader(
        cls, country_code: int, loader: Callable[[int], None]
    ) -> None: ...
    @classmethod
