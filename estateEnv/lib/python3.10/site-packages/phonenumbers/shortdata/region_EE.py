...
PHONE_METADATA_EE = PhoneMetadata(
    ...
    toll_free=PhoneNumberDesc(
        national_number_pattern="1(?:1(?:[02]|6\\d{3})|2(?:05|28)|3(?:014|3(?:21|5\\d?)|660)|492|5(?:1[03]|410|501)|6(?:112|333|644)|7(?:012|127|89)|8(?:10|8[57])|9(?:0[134]|14))",
        example_number="110",
    ...
    emergency=PhoneNumberDesc(
        national_number_pattern="11[02]", example_number="110", possible_length=(3,)
    ),
    short_code=PhoneNumberDesc(
        national_number_pattern="1(?:1(?:[02-579]|6(?:000|111)|8(?:[09]\\d|[1-8]))|2[36-9]|3[7-9]|4[05-7]|5[6-8]|6[05]|7[3-6]|8[02-7]|9[3-9])|1(?:2[0-245]|3[0-6]|4[1-489]|5[0-59]|6[1-46-9]|7[0-27-9]|8[189]|9[0-2])\\d\\d?",
        example_number="110",
        possible_length=(3, 4, 5, 6),
    ),
