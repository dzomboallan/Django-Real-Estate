...
PHONE_METADATA_SN = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="[12]\\d{1,5}", possible_length=(2, 3, 4, 5, 6)
    ),
    ...
    emergency=PhoneNumberDesc(
        national_number_pattern="1[78]", example_number="17", possible_length=(2,)
    ),
    short_code=PhoneNumberDesc(
        national_number_pattern="1(?:1[69]|(?:[246]\\d|51)\\d)|2(?:0[0-246]|[12468])\\d{3}|1[278]",
        example_number="12",
