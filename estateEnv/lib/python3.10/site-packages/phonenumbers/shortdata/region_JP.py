...
PHONE_METADATA_JP = PhoneMetadata(
    ...
    general_desc=PhoneNumberDesc(
        national_number_pattern="[01]\\d\\d(?:\\d{7})?", possible_length=(3, 10)
    ),
    toll_free=PhoneNumberDesc(
        national_number_pattern="11[089]", example_number="110", possible_length=(3,)
    ),
    emergency=PhoneNumberDesc(
        national_number_pattern="11[09]", example_number="110", possible_length=(3,)
    ),
