...
from .util import (ImmutableMixin, UnicodeMixin, force_unicode,
                   mutating_method, rpr, to_long, u, unicod)
...
class PhoneNumber(UnicodeMixin):
    ...
    def __init__(
        ...
        # as well.
        self.preferred_domestic_carrier_code = force_unicode(
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and bool(self.italian_leading_zero) == bool(other.italian_leading_zero)
    ...
    def __repr__(self):
        return unicod(
            "%s(country_code=%s, national_number=%s, extension=%s, "
    ...
    def __unicode__(self):
        ...
        if self.number_of_leading_zeros is not None:
            result += (
                unicod(" Number of leading zeros: %d") % self.number_of_leading_zeros
            )
        ...
        if self.preferred_domestic_carrier_code is not None:
            result += (
                unicod(" Preferred Domestic Carrier Code: %s")
