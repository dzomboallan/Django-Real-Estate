...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+254722200000")
    about_me = models.TextField(verbose_name=_("About me"), default = "Say something about yourself")
    lincense = models.CharField(verbose_name=_("Real Estate Lincense"), max_length=20, blank=True, null=True)
    ...
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=("Are you looking to sell a prperty?"))
